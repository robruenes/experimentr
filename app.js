...
// Example run command: `node app.js 9000 true`; listen on port 9000, debug printing on.
...
// Database setup
// add json encoding so leveldb knows you're saving json
leveldb = levelup('./lexperimentrdb', { valueEncoding: 'json' } )
